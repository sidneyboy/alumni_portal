...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <center>
                    <form method="post" action="{{ route('user_year_graduated_process') }}">
                        @csrf
                        <div class="card" style="width:50%;">
                            <div class="card-header" style="color:blue;">
                                Mr. {{ Str::ucfirst($user->name) }} *Please input the year you graduated! Thank you
                            </div>
                            <div class="card-body">
                                <input type="number" min="1900" max="2099" step="1" value="2016"
                                    name="year_graduated" id="form3Example123123123"
