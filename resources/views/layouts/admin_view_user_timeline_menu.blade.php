    ...
    <div class="header-links">
        <ul class="links d-flex align-items-center mt-3 mt-md-0">
            <li class="header-link-item d-flex align-items-center">
                ...
                <a class="pt-1px d-none d-md-block" href="{{ url('admin_view_user_timeline', ['id' => $user->id]) }}">Timeline</a>
            </li>
            <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                ...
                <a class="pt-1px d-none d-md-block" href="{{ url('admin_view_user_photos', ['id' => $user->id]) }}">Photos</a>
            </li>
            <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
