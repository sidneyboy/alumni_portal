            ...
            <div class="row profile-body">
                <div class="col-md-12 col-xl-12 middle-wrapper">
                    <div class="card rounded">
                        <div class="card-body">
                            <table class="table table-bordered table-hover table-striped table-sm" id="example">
                                <thead>
                                    <tr>
                                        <th>Title</th>
                                        <th>User</th>
                                ...
                                <tbody>
                                    @foreach ($survey as $data)
                                        @foreach ($data->details as $details)
                                            <tr>
                                                <td>{{ $data->admin_survey->title }}</td>
                                                <td>{{ Str::ucfirst($data->user->name) }}
                                                    {{ Str::ucfirst($data->user->middle_name) }}
                                                    {{ Str::ucfirst($data->user->last_name) }}</td>
