        ...
        <div class="profile-page tx-13">
            <div class="row">
                <div class="col-12 grid-margin">
                    @include('layouts/user_view_user_menu')
                </div>
            </div>
                                ...
                                <div class="card gedf-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a class="card-link" data-toggle="collapse"
                                            href="#collapseExampleuser_view_user_wall_reply{{ $wall_item->id }}"
                                            role="button" aria-expanded="false"
                                            aria-controls="collapseExampleuser_view_user_wall_reply{{ $wall_item->id }}">
                                            <i class="fa fa-comment"></i> Comment
                                        </a>
                                        <a class="card-link"
                                            href="{{ url('user_view_user_wall', ['id' => $wall_item->id]) }}">
                                            <span
                                    ...
                                    <div class="card-footer">
                                        <form action="{{ route('user_view_user_wall_reply') }}" method="post">
                                            @csrf
                                            <div class="collapse"
                                                id="collapseExampleuser_view_user_wall_reply{{ $wall_item->id }}">
